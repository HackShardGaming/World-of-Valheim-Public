...
User Level Commands:
		...
		// Del the permission_node from the user.
...
Group Level Commands:
		...
		// Deletes the group (GROUP_NAME)
		// Note: This will not only remove the group but all users and permission nodes directly associated with the group.  Please use this with care!
		...
		// Del the permission_node from the group
...
User Level Requests:
		...
		ValheimPermissions.ValheimDB.ScanUserPermission(SteamID, PERMISSION_NODE)
        // Important Note: You need to send the SteamID in STRING format instead of the default LONG format. use SteamID.ToString() before sending.
        ...
        // NOTE: Results will be returned to you in BOOL format (true/false)
        	...
        	ValheimPermissions.ValheimDB.DelUserPermission(STEAMID, PERMISSION_NODE)
        // Important Note: You need to send the SteamID in STRING format instead of the default LONG format. use SteamID.ToString() before sending.
